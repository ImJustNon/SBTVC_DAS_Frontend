...
router.get("/p/form", check_login, async(req, res) =>{
    ...
    const check_form_history = await axios.get(`http://127.0.0.1:808/api/form/check_send_form_history?student_id=${req.session.student_id}`).catch(err => console.log(err));
